...
%% Define parameters
% Material properties
D_1=40; % Define diffusivity of cathode material [um^2/s] (LSCF)
D_2=400;  % Define diffusivity of electrolyte material [um^2/s] (GDC)
...
L_1 = 20; % Length of LSCF [um]
L_2 = 80; % Length of GDC [um]
...
% A(L_1/delta_x,L_1/delta_x-1)=sigma_1+0.25*(sigma_int-sigma_1);
% A(L_1/delta_x,L_1/delta_x)=1-2*sigma_1;
% A(L_1/delta_x,L_1/delta_x+1)=sigma_1-0.25*(sigma_int-sigma_1);
% 
% A(L_1/delta_x+1,L_1/delta_x)=sigma_int+0.25*(sigma_2-sigma_1);
% A(L_1/delta_x+1,L_1/delta_x+1)=1-2*sigma_int;
% A(L_1/delta_x+1,L_1/delta_x+2)=sigma_int-0.25*(sigma_2-sigma_1);
% 
% A(L_1/delta_x+2,L_1/delta_x+1)=sigma_2+0.25*(sigma_2-sigma_int);
% A(L_1/delta_x+2,L_1/delta_x+2)=1-2*sigma_2;
% A(L_1/delta_x+2,L_1/delta_x+3)=sigma_2-0.25*(sigma_2-sigma_int);
...
% A_n(L_1/delta_x,L_1/delta_x-1)=-sigma_1+0.25*(sigma_int-sigma_1);
% A_n(L_1/delta_x,L_1/delta_x)=1+2*sigma_1;
% A_n(L_1/delta_x,L_1/delta_x+1)=-sigma_1-0.25*(sigma_int-sigma_1);
% 
% A_n(L_1/delta_x+1,L_1/delta_x)=-sigma_int+0.25*(sigma_2-sigma_1);
% A_n(L_1/delta_x+1,L_1/delta_x+1)=1+2*sigma_int;
% A_n(L_1/delta_x+1,L_1/delta_x+2)=-sigma_int-0.25*(sigma_2-sigma_1);
% 
% A_n(L_1/delta_x+2,L_1/delta_x+1)=-sigma_2+0.25*(sigma_2-sigma_int);
% A_n(L_1/delta_x+2,L_1/delta_x+2)=1+2*sigma_2;
% A_n(L_1/delta_x+2,L_1/delta_x+3)=-sigma_2-0.25*(sigma_2-sigma_int);
