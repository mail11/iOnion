function [Dk,data,cn] = CNIntFitting(CNInt(Dk))
...
if DeveloperMode == 0
    ...
    if str2double(answer(2)) == 1
        disp(['D1 = ',num2str(Dk(1)),' k = ',num2str(Dk(2))]);
    elseif str2double(answer(2)) == 2
        disp(['D1 = ',num2str(Dk(1)),'  D2 = ',num2str(Dk(2)),' DINT = ',num2str(Dk(3)),' k = ',num2str(Dk(4))]); % display the output variables
