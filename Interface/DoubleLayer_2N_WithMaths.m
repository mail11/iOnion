...
sub(1:L(1)/delta_x-2,1)=sigma_1;
sub(L(1)/delta_x-1,1)=0.25*(sigma_int-sigma_1)+sigma_1;
sub(L(1)/delta_x,1)=0.25*(sigma_int-sigma_1)+sigma_int;
sub(L(1)/delta_x+1,1)=0.25*(sigma_2-sigma_int)+sigma_int;
sub(L(1)/delta_x+2,1)=0.25*(sigma_2-sigma_int)+sigma_2;
sub(L(1)/delta_x+3:end,1)=sigma_2;

sup = zeros(round(steps_x)-1,1);
sup(1:L(1)/delta_x-2,1)=sigma_1;
sup(L(1)/delta_x-2,1)=sigma_1-0.25*(sigma_int-sigma_1);
sup(L(1)/delta_x-1,1)=sigma_int-0.25*(sigma_int-sigma_1);
sup(L(1)/delta_x,1)=sigma_int-0.25*(sigma_2-sigma_int);
sup(L(1)/delta_x+1,1)=sigma_2-0.25*(sigma_2-sigma_int);
sup(L(1)/delta_x+2:end,1)=sigma_2;

sub_n = zeros(round(steps_x)-1,1);
sub_n(1:L(1)/delta_x-2,1)=-sigma_1;
sub_n(L(1)/delta_x-1,1)=0.25*(sigma_int-sigma_1)-sigma_1;
sub_n(L(1)/delta_x,1)=0.25*(sigma_int-sigma_1)-sigma_int;
sub_n(L(1)/delta_x+1,1)=0.25*(sigma_2-sigma_int)-sigma_int;
sub_n(L(1)/delta_x+2,1)=0.25*(sigma_2-sigma_int)-sigma_2;
sub_n(L(1)/delta_x+3:end,1)=sigma_2;

sup_n = zeros(round(steps_x)-1,1);
sup_n(1:L(1)/delta_x-2,1)=-sigma_1;
sup_n(L(1)/delta_x-2,1)=-sigma_1-0.25*(sigma_int-sigma_1);
sup_n(L(1)/delta_x-1,1)=-sigma_int-0.25*(sigma_int-sigma_1);
sup_n(L(1)/delta_x,1)=-sigma_int-0.25*(sigma_2-sigma_int);
sup_n(L(1)/delta_x+1,1)=-sigma_2-0.25*(sigma_2-sigma_int);
sup_n(L(1)/delta_x+2:end,1)=-sigma_2;

s1 = zeros(round(steps_x),1);
s1(1:L(1)/delta_x-1,1)=1-2*sigma_1;
s1(L(1)/delta_x:L(1)/delta_x+1,1)=1-2*sigma_int;
s1(L(1)/delta_x+2:end,1)=1-2*sigma_2;
...
A_n = full(gallery('tridiag',sub_n,-s1+2,sup_n));
