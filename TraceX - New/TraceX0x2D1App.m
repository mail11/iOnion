classdef TraceX0x2D1App < handle
    %
    % Usage:
    %     app.TraceX0x2D1App
    ...
    properties (Constant)
        AppPathBase = {'/TraceX - 1'};
        AppClass = 'TraceX0x2D1App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            TraceX0x2D1App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'TraceX')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong TraceX
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'TraceX').getString, ...
